...
import torch
import ttach as tta
from submodules.pytorch_grad_cam.activations_and_gradients import (
...
# idx2class = load("imagenet_classes.pkl.gz")
...
class BaseCAM:
    ...
    def get_cam_image(
        self, input_tensor, target_category, activations, grads, eigen_smooth=False
    ):
    ...
    def forward(
        ...
        # Activate if you need to print out the top scoring imagenet class.
        # ic(idx2class[target_category.item()])
        ...
        cam = self.get_cam_image(
            input_tensor, target_category, activations, grads, eigen_smooth
        )
    ...
    def __call__(
        self, input_tensor, target_category=None, aug_smooth=False, eigen_smooth=False
    ):
